...
void spamBeacon(ros::NodeHandle &handle)
{
    ...
    const float localFakeX =0.0001; //meters
    ...
    while (ros::ok())
    {
        ...
        beacon.robot_name = "fake2";
        beacon.robot_type = "robot2";
...
{
    ros::init(argc, argv, "rosmapinterface_fakerobot2");
